...
subroutine eos_hllc_analytic_utow(u,w,temp,egv)
    ...
    w(4)=vz
    w(5)=p
end subroutine eos_hllc_analytic_utow
...
subroutine eos_analytic_utosource(u,source)
...
end subroutine eos_analytic_utosource

subroutine eos_analytic_sourcetou(source,u)
    real(8) :: u(5),source(5),rho,vx,vy,vz
    u(1:4)=source(1:4)
    rho=source(1)
    vx=source(2)/rho
...
end subroutine eos_analytic_sourcetou
