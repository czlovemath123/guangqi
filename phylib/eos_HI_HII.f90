...
function eos_h_cv(rho,t,temp1,temp2)
    real(8) :: eos_h_cv,rho,t,t1,t2,xi_h,xi_hion,xi_e,xi_he
...
function zh(t)
    ...
    zh=(8d0*sqrt(2d0)*pi**1.5d0*(kb*mh*t)**1.5d0)/h_planck**3
end function zh

function ze(t)
    real(8) :: ze,t,ztr,zspin
    ze=(4d0*sqrt(2d0)*pi**1.5d0*(kb*me*t)**1.5d0)/h_planck**3
end function ze

function zhion(t)
    real(8) :: zhion,t,ztr,zspin,zelec,mhion
    mhion=mh-me
    zhion=(4d0*sqrt(2d0)*pi**1.5d0*(kb*mhion*t)**1.5d0)/(exp(ionh/kb/t)*h_planck**3)
end function zhion

function zhe(t)
    real(8) :: zhe,t
    zhe=(4d0*sqrt(2d0)*pi**1.5*(kb*mhe*t)**1.5)/h_planck**3
end function zhe
